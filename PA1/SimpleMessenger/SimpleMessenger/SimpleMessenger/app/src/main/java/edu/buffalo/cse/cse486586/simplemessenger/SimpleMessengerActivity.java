...
public class SimpleMessengerActivity extends Activity {
    ...
    private class ServerTask extends AsyncTask<ServerSocket, String, Void> {
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            //mainly I referred to example code on how to write client server socket programming from the following link
            //https://stackoverflow.com/questions/38668203/java-socket-read-write
            //I read about socket programming and how to write reading and writing to socket from following link
            //https://docs.oracle.com/javase/tutorial/networking/sockets/clientServer.html
            //The below link is reference in understanding more (flush,println and ordering) on client server socket programming
            //https://stackoverflow.com/questions/42048412/client-unable-to-send-messages-to-server-java-socket
            // for calling publish progress I referred on how to use asynctask in android from following link
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                //mainly I referred to example code on how to write client server socket programming from the following link
                //https://stackoverflow.com/questions/38668203/java-socket-read-write
                //Initially, I read about socket programming and how to write reading and writing to socket from following link
                //https://docs.oracle.com/javase/tutorial/networking/sockets/clientServer.html
                //The below link is reference in understanding more (flush,println and ordering) on client server socket programming
                //https://stackoverflow.com/questions/42048412/client-unable-to-send-messages-to-server-java-socket
                // for calling publish progress I referred on how to use asynctask in android from following link
